...
import com.astro.seven.Utils.SectionsPagerAdapter;
...
public class HomeActivity extends AppCompatActivity {
    ...
    /**
     * Sets up the tabs camera home messages
     */
    private void setupViewPager(){
        ...
        tabLayout.getTabAt(1).setIcon(R.drawable.ic_seven_logo);
